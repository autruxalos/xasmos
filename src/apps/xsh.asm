...
; Núcleo: bucle, parser, dispatcher, prompt
; Comandos: cada uno en /src/apps/xsh/<comando>.asm
; Prompt: |user|<usuario>|@   (normal)
;         |user|<usuario>|%   (sprusr)
; =============================================================================
[BITS 64]
...
; -----------------------------------------------------------------------
; Estado compartido (ANTES de los includes de comandos)
; -----------------------------------------------------------------------
...
msg_unknown_cmd:  db 'XSH: unknown command. Type "ver" for help.', 10, 0
...
cmd_table:
    ...
    dq str_cmd_locate,     xsh_cmd_locate
...
; -----------------------------------------------------------------------
; Prompt: |user|<username>|@  or  |user|<username>|%
; -----------------------------------------------------------------------
xsh_print_prompt:
    mov  bl, 0x0B
    mov  rsi, msg_pipe
